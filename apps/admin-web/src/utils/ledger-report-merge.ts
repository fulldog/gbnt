...
export function composeStreetRow(base: StreetBaseRow, statistics: StreetStatisticsRow): StreetLedgerReportRow {
  return {
    ...
    well_report_count: statistics.well_report_count,
    bridge_report_count: statistics.bridge_report_count,
    transformer_report_count: statistics.transformer_report_count,
    road_tree_survive: statistics.road_tree_survive,
