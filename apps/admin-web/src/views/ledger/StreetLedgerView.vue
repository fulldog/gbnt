...
function exportReport(table: HTMLTableElement): void {
  ...
  try { exportLedgerTable(table, ledgerExportName("街道台账", report.value.query)); }
...
<template>
  <LedgerReportFrame title="街道台账" :loading="loading" :export-disabled="!canExport" @refresh="load" @export="exportReport">
