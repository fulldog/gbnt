...
var apisSysStaff = []Entry{
	...
	{Method: "GET", Path: "/api/sys/users/options/roles", Name: "工作人员可分配角色", Module: "web.sys-staff", Action: "view", Sort: 17},
	...
	{Method: "PUT", Path: "/api/sys/users/:id/status", Name: "更新用户状态", Module: "web.sys-staff", Action: "edit", Sort: 21},
