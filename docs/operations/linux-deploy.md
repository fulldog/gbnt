...
- systemd 定时器：`sudo bash deploy/systemd/git-pull-rebuild.sh install`
- crontab：`sudo cp deploy/cron/gbnt-pull /etc/cron.d/gbnt-pull && sudo chmod 644 /etc/cron.d/gbnt-pull`
