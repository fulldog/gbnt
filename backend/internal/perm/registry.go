...
var Registry = []Entry{
	...
	{Method: "POST", Path: "/api/sys/users", Name: "新增用户", Module: "web.sys-staff", Action: "create", Sort: 18},
	{Method: "PUT", Path: "/api/sys/users/:id", Name: "更新用户", Module: "web.sys-staff", Action: "edit", Sort: 19},
	{Method: "POST", Path: "/api/sys/users/:id/reset-password", Name: "重置密码", Module: "web.sys-staff", Action: "edit", Sort: 20},
	{Method: "DELETE", Path: "/api/sys/users/:id", Name: "删除用户", Module: "web.sys-staff", Action: "delete", Sort: 21},
	{Method: "GET", Path: "/api/sys/roles", Name: "角色列表", Module: "web.sys-roles", Action: "view", Sort: 22},
	{Method: "POST", Path: "/api/sys/roles", Name: "新增角色", Module: "web.sys-roles", Action: "create", Sort: 23},
	{Method: "PUT", Path: "/api/sys/roles/:id", Name: "更新角色", Module: "web.sys-roles", Action: "edit", Sort: 24},
	{Method: "DELETE", Path: "/api/sys/roles/:id", Name: "删除角色", Module: "web.sys-roles", Action: "delete", Sort: 25},
	{Method: "GET", Path: "/api/sys/roles/:id/apis", Name: "角色API权限", Module: "web.sys-roles", Action: "view", Sort: 26},
	{Method: "PUT", Path: "/api/sys/roles/:id/apis", Name: "设置角色API权限", Module: "web.sys-roles", Action: "edit", Sort: 27},
	{Method: "GET", Path: "/api/sys/apis", Name: "API目录列表", Module: "web.sys-roles", Action: "view", Sort: 28},
	{Method: "GET", Path: "/api/sys/op-logs", Name: "操作日志", Module: "web.sys-logs", Action: "view", Sort: 29},
}
